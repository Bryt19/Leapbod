...
const Hero = () => {
  ...
  return (
    <section className="relative py-20 overflow-hidden border-y border-border">
      ...
      <img
        src="/hero.jpg"
        alt="Students exploring opportunities"
        className="absolute inset-0 w-full h-full object-cover"
      />
      {/* Overlay for readability in both themes */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
            Discover scholarships, internships, and research opportunities all
            in one place. Take the next step in your academic journey.
          </p>
