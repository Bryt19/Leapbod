    ...
    <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group relative h-full flex flex-col">
      ...
      {opportunity.application_url ? (
        <a
          ...
          className={`w-full bg-primary hover:bg-primary/90 text-primary-foreground py-3 rounded-lg font-medium hover:shadow-lg hover:scale-105 transition-all duration-200 flex items-center justify-center mt-auto ${
        ...
        >
          ...
          {!isDeadlinePassed() && <HiExternalLink className="w-4 h-4 ml-2" />}
        </a>
      ) : (
        <button
          disabled
          className="w-full bg-gray-300 text-gray-500 py-3 rounded-lg font-medium cursor-not-allowed mt-auto"
        >
          No Link Available
        </button>
      )}
